...
@Slf4j
public class ReactorRedisDemoApplication implements ApplicationRunner {

    public static void main(String[] args) {
        SpringApplication.run(ReactorRedisDemoApplication.class, args);
    }
    ...
    public void run(ApplicationArguments args) throws Exception {
        ReactiveHashOperations<String, String, String> opHash = redisTemplate.opsForHash();
        ...
        Flux.fromIterable(list)
                ...
                .flatMap(c -> {
                            ...
                            return opHash.put(KEY, c.getName(), String.valueOf(c.getPrice()));
                        }
                )
